...
%% Display Points, To see pre and post pruning uncomment below
...
% returns the similarities for the left and right images 
...
% uncomment to show all matched keypoints
%f3 = figure('Name', 'Together');
%imshow(together);
%imwrite(together, 'together_matched_keys.jpg')
...
left_best = im_left(:, :, :);
right_best = im_right(:, :, :);
best = [left_best right_best];

for i = 1:size(best_corrs, 1)
